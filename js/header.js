...
var checkHeader = _.throttle(() => {
  ...
  if (scrollPosition > 50) {
    ...
    // document.getElementById("main-logo").classList.add("sticky-logo");
    // document.getElementById("contact-nav").classList.add("sticky-contact");
  }
  // If not, remove "sticky" class from header
  else {
    document.querySelector("header").classList.remove("header-hide");
    // document.querySelector("nav").classList.remove("sticky-nav");
    // document.getElementById("main-logo").classList.remove("sticky-logo");
    // document.getElementById("contact-nav").classList.remove("sticky-contact");
  }
}, 300);
